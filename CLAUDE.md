...
1. **npm package** (`packages/soda/`): Contains all source code, skill bodies, agent bodies, CLI, TUI, and core library. Published as `@whatasoda/agent-tools` with CLI entry point `sd`.
