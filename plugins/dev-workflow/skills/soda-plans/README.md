...
- **Read-only constraint**: Like `soda-review-branch`, this skill must not modify anything. Its purpose is to present information, not to act on it.
...
- Integration with `/soda-plan-implementation` for plan refinement workflow
