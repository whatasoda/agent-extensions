...
1. Launch a codex review subagent:
   ...
   - Review request:
     ...
     - **Mode**: init
     - **Instruction**: "Review this implementation plan. Focus on step completeness, dependency correctness, and acceptance criteria verifiability — only flag critical problems"
